...
This document provides a quick-start for developers of the Non-RT RIC A1 Policy Management Service.
...
on the `Run in Docker wiki page <https://lf-o-ran-sc.atlassian.net/wiki/spaces/RICNR/pages/929792252/Release+N+-+Run+in+Docker>`_
...
see `Deploy NONRTRIC functions in Kubernetes <https://lf-o-ran-sc.atlassian.net/wiki/spaces/RICNR/pages/929792370/Release+N+-+Run+in+Kubernetes>`_.
